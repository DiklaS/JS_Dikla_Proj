...
import {checkUrlInput, checkAltInput, checkCreditInput, checkPriceInput} from "../validation/validateEditForm.js";
...
const editPropertiesPopupSaveBtn = document.getElementById("editPropertiesPopupSaveBtn");
...
const initPopup = (selectedPropertyFromHomePage, editPropertyFromHomePage) => {
  ...
  if (editPropertiesPopupAlt.value !== "") {
    checkAltInput();
  }
...
window.addEventListener("load", () => {
  ...
  document
    ...
    .addEventListener("click", () => {
      ...
      selectedProperty.price = editPropertiesPopupPrice.value + ' NIS';
